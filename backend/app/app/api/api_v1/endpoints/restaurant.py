...
@router.get(
    '/cp/restaurants/',
    response_model=schemas.ListOfEntityResponse[schemas.GettingCPRestaurant],
    name="Получить все доступные рестораны",
...
def get_all(
    ...
    return schemas.ListOfEntityResponse(
        data=[
            getters.restaurant.get_cp_restaurant(db=db, restaurant=restaurant)
            for restaurant
            in data
        ],
        meta=schemas.response.Meta(paginator=paginator)
...
@router.post(
    '/cp/restaurants/',
    response_model=schemas.SingleEntityResponse[schemas.GettingCPRestaurant],
...
def create_restaurant(
    ...
    return schemas.SingleEntityResponse(
        data=getters.restaurant.get_cp_restaurant(restaurant=restaurant, db=db)
    )
...
def edit_restaurant(
    ...
    return schemas.SingleEntityResponse(data=getters.restaurant.get_cp_restaurant(db=db, restaurant=restaurant))
...
def get_restaurant(
    ...
    return schemas.SingleEntityResponse(data=getters.restaurant.get_cp_restaurant(restaurant=restaurant, db=db))
...
@router.post(
    ...
    response_model=schemas.response.SingleEntityResponse[schemas.restaurant.GettingCPRestaurant],
...
def delete_image(
    ...
    return schemas.response.SingleEntityResponse(
        data=getters.restaurant.get_cp_restaurant(db=db, restaurant=restaurant_image.restaurant)
    )
